...
namespace ConsoleApp1.Controllers
{
    ...
    public class ExampleController
    {
        ...
        public HttpResponseTemplate HomeRoute(HttpListenerRequest request)
        {
            ...
            TestController testController = ControllersContainer.GetItem<TestController>();
            testController.Toto = 5; 
            string responseString = "<HTML><BODY> Hello world! " +  testController.Toto + "</BODY></HTML>";
